(function () {
  ...
  const DATENSCHUTZ_HTML =
    ...
    '<h3>Löschung</h3>' +
    '<p>Du kannst einzelne Profile jederzeit über den Papierkorb-Button oder alle Profile gesammelt über „Einstellungen → Alle Profile löschen" entfernen. Eine vollständige Löschung aller App-Daten ist zusätzlich über die Browser- bzw. iOS-Systemeinstellungen möglich (App-Daten/Website-Daten löschen).</p>' +
    '<h3>Hosting</h3>' +
